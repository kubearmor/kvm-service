...
SERVICE_PATH=`dirname $(realpath "$0")`/../service
...
cp $SERVICE_PATH/main.go $ARMOR_HOME/build/KVMService/
 ...
 cp $ARMOR_HOME/build/patch.sh $ARMOR_HOME/build/KVMService/
 cp $ARMOR_HOME/build/patch_selinux.sh $ARMOR_HOME/build/KVMService/
