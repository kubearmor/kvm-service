...
mkdir -p $ARMOR_HOME/build/KVMService/service
...
cp $SERVICE_PATH/main.go $ARMOR_HOME/build/KVMService/service

 cp $SERVICE_PATH/build/patch.sh $ARMOR_HOME/build/KVMService/service
 cp $SERVICE_PATH/build/patch_selinux.sh $ARMOR_HOME/build/KVMService/service
